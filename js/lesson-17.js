...
//   elements.digitalClock.textContent = `Поточний час
//   ${formatTime(current.hours)}:
//   ${formatTime(current.minutes)}:
//   ${formatTime(current.seconds)}`;

//   const secondsDeg = (360 / 60) * current.seconds + (360 / 60 / 1000) * current.miliseconds;
//   const minutesDeg = (360 / 60) * current.minutes + (360 / 60 / 60) * current.seconds;
